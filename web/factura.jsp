...
<html>
    <head>
        ...
        <%
            ...
            int cod_factura = 0; // Integer.parseInt(request.getParameter("cod_factura"));

            Factura fac = mane_fac.obtenerFacturaPorCod(cod_factura);
            ArrayList<Orden_compra> arrayCompras = mane_ord.listaDeComprasPorFactura(cod_factura);
            UsuarioCli_detalle cli = mane_cli.obtenerClienteCompleto(arrayCompras.get(0).getCliente_rut_emp());
            Usuario usu = mane_usu.obtenerUsuarioPorId(cli.getUsuario_id_usuario());
            java.sql.Date f_ven = mane_fac.fecha_vencimiento(fac.getF_emicion());
