...
CREATE TABLE cliente (
    rut_emp              VARCHAR2(50) NOT NULL,
    nom_emp              VARCHAR2(50) NOT NULL,
    tele_emp             VARCHAR2(50) NOT NULL,
    dir_emp              VARCHAR2(50) NOT NULL,
...
CREATE TABLE empleado (
    rut_empleado         VARCHAR2(50) NOT NULL,
...
CREATE TABLE huesped (
    rut_huesped                  VARCHAR2(30) NOT NULL,
    nombre                       VARCHAR2(50) NOT NULL,
    apellido                     VARCHAR2(50) NOT NULL,
...
CREATE TABLE orden_compra (
    ...
    tipo_hab_id_tipo_hab      INTEGER NOT NULL,
    tipo_minuta_id_tipo_min   INTEGER NOT NULL,
    cliente_rut_emp           VARCHAR2(50) NOT NULL,
...
CREATE TABLE orden_pedido (
    ...
    f_recepcion             DATE,
    estado                  INTEGER,
    proveedor_rut           VARCHAR2(50),
    empleado_rut_empleado   VARCHAR2(50)
);
